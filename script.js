...
<div class="post-hero-content">
    ...
    <div style="margin-top: 3rem; text-align: center; padding: 2rem; background: var(--primary); color: white; border-radius: var(--radius); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        ...
        <div class="social-share" style="justify-content: center; margin-top: 1.5rem;">
            ...
            post1_desc: "Un importante incontro dedicato allo screening mammografico, aperto a tutte le donne del territorio per informazione e orientamento.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZZATO DA: ARRT e ASL ROMAGNA</strong>",
            ...
            post2_desc: "Un percorso per donne e ragazze per costruire il proprio progetto di vita, ricercare opportunità professionali ed educazione finanziaria.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZZATO DA: apeiron</strong>",
            ...
            post6_date: "16 maggio 2026 | Ore 16:30",
            post6_title: "Evento \"Nati per Leggere\"",
            post6_desc: "Un pomeriggio speciale per bambini da 0 a 8 anni alla Biblioteca Malatestiana, tra lingue, suoni e storie dal mondo.",
            post6_full: "<p>Siamo lieti di invitarvi sabato 16 maggio, alle ore 16:30, alla Biblioteca Malatestiana, in occasione della settimana Nati per Leggere.</p><p>Vi aspettiamo a \"Letture in Viaggio\", un evento dedicato ai bambini da 0 a 8 anni, tra lingue, suoni e storie da tutto il mondo.</p><p>Un pomeriggio speciale per condividere insieme la gioia della lettura, della scoperta e dell'immaginazione.</p><p>📍 <strong>Dove:</strong> Biblioteca Malatestiana<br>🗓 <strong>Quando:</strong> Sabato 16 maggio<br>🕟 <strong>Ora:</strong> 16:30<br>👧🧒 <strong>Per:</strong> Bambini da 0 a 8 anni</p>",
            post7_date: "16 maggio 2026 | Ore 10:00 - 12:00",
            post7_title: "Incontro \"BenEssere - Donne protagoniste della prevenzione\"",
            post7_desc: "Un incontro dedicato alla prevenzione sanitaria e corretta alimentazione, con accesso diretto ai percorsi di screening.",
            post7_full: "<p>Il corpo umano è Dono e Responsabilità. Incontriamoci per parlare di prevenzione sanitaria e corretta alimentazione. Prevenire è importante per vivere una vita sana e rispettosa della propria persona.</p><p>Evento ad accesso libero e gratuito per tutte le famiglie. Per tutta la durata dell'evento sarà a disposizione uno spazio ludico per i più piccoli.</p><p>Ci sarà inoltre la possibilità di accedere direttamente ai percorsi di screening grazie alla presenza del Centro screening di Forlì e Cesena.</p><p>📍 <strong>Dove:</strong> Sala Galeffi, Piazza Borghesi, 9 - Savignano sul Rubicone<br>🗓 <strong>Quando:</strong> Sabato 16 maggio<br>🕙 <strong>Ora:</strong> 10:00 - 12:00</p>",
            ...
            partner_1: "Associazione Cimbrișor",
            partner_2: "Associazione Busuioc",
            partner_3: "Associazione Vatra",
            partner_4: "Consolato Generale della Repubblica di Moldova a Milano",
            partner_5: "Autorità Locali",
            partner_6: "Associazione \"Dante Alighieri\", Cesena",
            partner_7: "Associazione LA SCACCHIERA DI ONNON",
            partner_8: "CSI FORLÌ",
            partner_9: "Trenino delle stelle",
            partner_10: "Progetto 11",
            partner_11: "L'Aquilone di Iqbal",
            partner_12: "Rainbow",
            partner_13: "La Botteghina",
            partner_14: "Garage 51",
            partner_15: "Il Gelatino",
            partner_16: "Șezătoarea Bruxelles",
            partner_17: "Scuola di Ballo Settecrociari",
            partner_18: "Guvernul Republicii Moldova",
            partner_19: "Biroul Relații cu Diaspora",
            partner_20: "Diaspora Engagement Hub",
            partner_21: "Ministerul Culturii al Republicii Moldova",
            partner_22: "Ambasciata Republicii Moldova",
            partner_23: "Associazione Albinuta",
            partner_24: "BCC Romagnolo",
            footer_brand: "AMIC",
...
<div class="post-hero-content">
    ...
    <div style="margin-top: 3rem; text-align: center; padding: 2rem; background: var(--primary); color: white; border-radius: var(--radius); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        ...
        <div class="social-share" style="justify-content: center; margin-top: 1.5rem;">
            ...
            post1_desc: "O întâlnire importantă dedicată screeningului mamar, deschisă tuturor femeilor din teritoriu pentru informare și orientare.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZAT DE: ARRT și ASL ROMAGNA</strong>",
            ...
            post2_desc: "Un curs pentru a vă consolida independența financiară și a construi propriul proiect de viață și rețea de sprijin.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZAT DE: apeiron</strong>",
            ...
            post6_date: "16 mai 2026 | Ora 16:30",
            post6_title: "Eveniment „Născuți pentru a citi”",
            post6_desc: "O după-amiază specială pentru copii între 0 și 8 ani la Biblioteca Malatestiana, printre limbi, sunete și povești din întreaga lume.",
            post6_full: "<p>Avem plăcerea să vă invităm sâmbătă, 16 mai, la ora 16:30, la Biblioteca Malatestiana, cu ocazia săptămânii Nati per Leggere.</p><p>Vă așteptăm la „Lecturi în Călătorie”, un eveniment dedicat copiilor cu vârste între 0 și 8 ani, printre limbi, sunete și povești din întreaga lume.</p><p>O după-amiază specială pentru a împărtăși împreună bucuria lecturii, a descoperirii și a imaginației.</p><p>📍 <strong>Unde:</strong> Biblioteca Malatestiana<br>🗓 <strong>Când:</strong> Sâmbătă, 16 mai<br>🕟 <strong>Ora:</strong> 16:30<br>👧🧒 <strong>Pentru:</strong> Copii cu vârste între 0 și 8 ani</p>",
            post7_date: "16 mai 2026 | Ora 10:00 - 12:00",
            post7_title: "Întâlnire „BenEssere - Femeile, protagoniste ale prevenției”",
            post7_desc: "O întâlnire dedicată prevenției în sănătate și alimentației corecte, cu acces direct la programele de screening.",
            post7_full: "<p>Corpul uman este un Dar și o Responsabilitate. Vă invităm să ne întâlnim pentru a discuta despre prevenția în sănătate și alimentația corectă. Prevenția este importantă pentru a trăi o viață sănătoasă și cu respect față de propria persoană.</p><p>Eveniment cu acces liber și gratuit pentru toate familiile. Pe toată durata evenimentului, va fi disponibil un spațiu de joacă pentru cei mici.</p><p>De asemenea, va exista posibilitatea de a accesa direct programele de screening, datorită prezenței Centrului de screening din Forlì și Cesena.</p><p>📍 <strong>Unde:</strong> Sala Galeffi, Piazza Borghesi, 9 - Savignano sul Rubicone<br>🗓 <strong>Când:</strong> Sâmbătă, 16 mai<br>🕙 <strong>Ora:</strong> 10:00 - 12:00</p>",
            ...
            partner_1: "Asociația Cimbrișor",
            partner_2: "Asociația Busuioc",
            partner_3: "Asociația Vatra",
            partner_4: "Consulatul General al Republicii Moldova la Milano",
            partner_5: "Autorități Locale",
            partner_6: "Asociația \"Dante Alighieri\", Cesena",
            partner_7: "Asociația LA SCACCHIERA DI ONNON",
            partner_8: "CSI FORLÌ",
            partner_9: "Trenino delle stelle",
            partner_10: "Progetto 11",
            partner_11: "L'Aquilone di Iqbal",
...
<div class="post-hero-content">
    ...
    <div style="margin-top: 3rem; text-align: center; padding: 2rem; background: var(--primary); color: white; border-radius: var(--radius); box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
        ...
        <div class="social-share" style="justify-content: center; margin-top: 1.5rem;">
            ...
            post1_desc: "An important meeting dedicated to breast cancer screening, open to all women in the area for information and guidance.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZED BY: ARRT and ASL ROMAGNA</strong>",
            ...
            post2_desc: "A course to build your life project, search for professional opportunities, and gain financial education.<br><strong style=\"color: var(--primary); font-size: 0.85rem; text-transform: uppercase;\">ORGANIZED BY: apeiron</strong>",
            ...
            post6_date: "May 16, 2026 | 4:30 PM",
            post6_title: "\"Born to Read\" Event",
            post6_desc: "A special afternoon for children aged 0 to 8 at the Malatestiana Library, amidst languages, sounds, and stories from around the world.",
            post6_full: "<p>We are pleased to invite you on Saturday, May 16th, at 4:30 PM, at the Malatestiana Library, on the occasion of the Nati per Leggere week.</p><p>We look forward to seeing you at \"Reading on the Go\", an event dedicated to children aged 0 to 8, amidst languages, sounds, and stories from around the world.</p><p>A special afternoon to share the joy of reading, discovery, and imagination.</p><p>📍 <strong>Where:</strong> Malatestiana Library<br>🗓 <strong>When:</strong> Saturday, May 16th<br>🕟 <strong>Time:</strong> 4:30 PM<br>👧🧒 <strong>For:</strong> Children aged 0 to 8</p>",
            post7_date: "May 16, 2026 | 10:00 AM - 12:00 PM",
            post7_title: "\"BenEssere\" Meeting - Women Protagonists of Prevention",
            post7_desc: "A meeting dedicated to health prevention and proper nutrition, with direct access to screening programs.",
            post7_full: "<p>The human body is a Gift and a Responsibility. Let's meet to talk about health prevention and proper nutrition. Prevention is important to live a healthy life and respect one's own body.</p><p>Free and open access event for all families. A play area for children will be available for the entire duration of the event.</p><p>There will also be the opportunity to directly access screening pathways thanks to the presence of the Forlì and Cesena Screening Center.</p><p>📍 <strong>Where:</strong> Sala Galeffi, Piazza Borghesi, 9 - Savignano sul Rubicone<br>🗓 <strong>When:</strong> Saturday, May 16<br>🕙 <strong>Time:</strong> 10:00 AM - 12:00 PM</p>",
            ...
            partner_2: "Asociația Busuioc",
            partner_3: "Asociația Vatra",
            partner_4: "Consulate General of the Republic of Moldova in Milan",
            partner_5: "Local Authorities",
            partner_6: "\"Dante Alighieri\" Association, Cesena",
            partner_7: "LA SCACCHIERA DI ONNON Association",
            partner_8: "CSI FORLÌ",
            partner_9: "Trenino delle stelle",
            partner_10: "Progetto 11",
            partner_11: "L'Aquilone di Iqbal",
            ...
            partner_21: "Ministerul Culturii al Republicii Moldova",
            partner_22: "Ambasciata Republicii Moldova",
            partner_23: "Albinuta Association",
            partner_24: "BCC Romagnolo",
            footer_brand: "AMIC",
